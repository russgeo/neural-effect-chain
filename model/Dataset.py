...
class EffectChainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        '''
        entry = self.data[idx]
        effects_chain = entry['effects_chain']
        dry_tone_path = entry['dry_tone_path']
        wet_tone_path = entry['wet_tone_path']
        wet_tone_features = entry['wet_tone_features']
        names = effects_chain.names
        effects = effects_chain.effects
        parameters = effects_chain.parameters
        return {"effects_chain": effects_chain, "dry_tone_path":dry_tone_path,"wet_tone_path":wet_tone_path,"wet_tone_features":wet_tone_features,"effect_names":names,"effects":effects, "parameters":parameters, "index":idx}